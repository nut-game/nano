...
var file_testrequest_proto_rawDesc = string([]byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x42, 0x08, 0x5a, 0x06, 0x2e, 0x3b,
	0x74, 0x65, 0x73, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
})

var (
	file_testrequest_proto_rawDescOnce sync.Once
	file_testrequest_proto_rawDescData []byte
)

func file_testrequest_proto_rawDescGZIP() []byte {
	file_testrequest_proto_rawDescOnce.Do(func() {
		file_testrequest_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_testrequest_proto_rawDesc), len(file_testrequest_proto_rawDesc)))
	})
	return file_testrequest_proto_rawDescData
}

var file_testrequest_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_testrequest_proto_goTypes = []any{
...
func file_testrequest_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_testrequest_proto_rawDesc), len(file_testrequest_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
